...
module.exports =
  ...
  extensions: [
    dynamic_content()
    css_pipeline(files: 'assets/css/*.scss', out: 'css/built.css', minify: true),
    browserify(files: ['assets/js/detect.js','assets/js/meow.js','assets/js/main.js'], out :'js/built.js', minify: true),
    contentful
      access_token: ''
      space_id: ''
      content_types:
